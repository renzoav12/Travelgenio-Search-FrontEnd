...
export interface PaginationUpdateAction extends Action<typeof SEARCH_PAGINATION_UPDATE> {
...
export type PaginationActionTypes = PaginationChangeAction | PaginationUpdateAction;