...
export const fetchSuggestionSearch = (
  queryParameters: SearchSuggestionParameters
...
export const fetchSuggestionSearchName = (
  queryParameters: SearchNameSuggestionParameters
): ThunkResult<void> => async (dispatch) => {
  handleFetchSuggestionSearchName(dispatch);

  try {
    const response: AxiosResponse<SuggestionEntry> = await search.get(
      "/autocomplete/" + queryParameters.code,
      {
        params: {
...
export const handleFetchSuggestionSearch = (
  dispatch: Dispatch<FetchSearchSuggestion>
) => {
  dispatch({
    type: SearchSuggestionsActionTypes.FETCH,
  });
...
export const handleSuggestionSearchFailed = (
  dispatch: Dispatch<FetchSearchSuggestionFailed>
) => {
  dispatch({
    type: SearchSuggestionsActionTypes.FETCH_FAILED,
  });
...
export const handleFetchSuggestionSearchName = (
  dispatch: Dispatch<FetchSearchSuggestionName>
) => {
  dispatch({
    type: SearchSuggestionsActionTypes.FETCH_NAME,
  });
...
export const handleSuggestionSearchNameFailed = (
  dispatch: Dispatch<FetchSearchSuggestionNameFailed>
) => {
  dispatch({
    type: SearchSuggestionsActionTypes.FETCH_NAME_FAILED,
  });
